...
export const PLATFORMS: { value: Platform; label: string; url: string; keyless?: boolean }[] = [
  ...
  { value: 'modelscope', label: 'ModelScope / 魔搭', url: 'https://modelscope.cn/my/myaccesstoken' },
  { value: 'sealion', label: 'SEA-LION', url: 'https://api.sea-lion.ai' },
  { value: 'navy', label: 'NavyAI', url: 'https://api.navy' },
