...
export function sanitizeResponse(payload) {
    const p = payload;
    ...
    if (Array.isArray(p.choices)) {
        for (const choice of p.choices) {
            ...
            if (c.message && typeof c.message === 'object' && c.message.tool_calls === null)
                delete c.message.tool_calls;
            if (c.delta && typeof c.delta === 'object' && c.delta.tool_calls === null)
