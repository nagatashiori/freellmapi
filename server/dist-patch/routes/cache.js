...
import { getCacheStats, clearCache, isCacheEnabled, cacheTtlMs, cacheMaxEntries, cacheMaxTemperature, CACHE_ENABLED_SETTING, } from '../services/cache.js';
...
cacheRouter.put('/config', (req, res) => {
