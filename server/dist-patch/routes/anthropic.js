...
import { z } from 'zod';
import { routeRequest, routingReserveTokens } from '../services/router.js';
...
import { runFallbackLoop, newFallbackState, recordUpstreamSuccess, setFallbackHeaders } from '../lib/fallback-loop.js';
...
// wire-correct.
function anthropicErrorType(body) {
    if (body.kind === 'auth')
        return 'api_error';
...
function rescuedToToolCalls(calls, schemas) {
