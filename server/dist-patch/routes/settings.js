...
import { getRequestMaxTokensBudget, getMaxConsecutiveUpstreamFails, REQUEST_MAX_TOKENS_BUDGET_SETTING, MAX_CONSECUTIVE_UPSTREAM_FAILS_SETTING, } from '../lib/guardrails.js';
import { z } from 'zod';
...
settingsRouter.get('/guardrails', (_req, res) => {
    res.json({
...
settingsRouter.put('/guardrails', (req, res) => {
